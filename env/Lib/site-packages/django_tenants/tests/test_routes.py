...
class RoutesTestCase(BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.public_domain = get_tenant_domain_model()(
            domain="test.com", tenant=cls.public_tenant
        )
...
class SubfolderRoutesTestCase(BaseTestCase):
    ...
    def test_tenant_routing(self):
        ...
        request = self.factory.get(
            "/clients/tenant.test.com/any/request/", HTTP_HOST=self.public_domain.domain
        )
    ...
    def test_missing_tenant(self):
        ...
        """
        request = self.factory.get(
            "/clients/not-found/any/request/", HTTP_HOST=self.public_domain.domain
        )

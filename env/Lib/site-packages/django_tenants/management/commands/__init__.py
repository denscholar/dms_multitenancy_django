...
class BaseTenantCommand(BaseCommand):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        obj.help = (
            "Calls %s for all registered schemata. You can use regular %s options. "
    ...
    def handle(self, *args, **options):
        ...
        if options["schema_name"] or self.schema_name:
            ...
            self.execute_command(
                get_tenant_model().objects.get(schema_name=schema_name),
                self.COMMAND_NAME,
                *args,
                **options
            )
            ...
            while True:
                ...
                if tenant_schema == "?":
                    print(
                        "\n".join(
                            [
                                "%s - %s" % (t.schema_name, t.get_primary_domain())
